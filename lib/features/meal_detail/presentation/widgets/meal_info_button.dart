...
import 'package:opennutritracker/features/add_meal/data/dto/logmeal/logmeal_const.dart';
  ...
  String _getInfoUrl() {
    ...
    switch (source) {
      ...
      case MealSourceEntity.logmeal:
        siteUrl = url ?? LogMealConst.logMealWebsiteUrl;
        break;
    }
    return siteUrl;
  }
  ...
  String _getInfoLabelText(BuildContext context) {
    ...
    switch (source) {
      ...
      case MealSourceEntity.fdc:
        ...
        break;
      case MealSourceEntity.logmeal:
        infoLabel = S.of(context).additionalInfoLabelLogMeal;
        break;
    }
    return infoLabel;
  }
