...
class IntakeDataSource {
  ...
  Future<void> addLogmealIntakeFromResponse(Map<String, dynamic> response) async {
    log.fine('Adding new Logmeal intake from API response');
    // Create a MealDBO from the Logmeal response using the new factory method
    final meal = MealDBO.fromLogmealResponse(response);
    // Construct a new IntakeDBO for breakfast (or assign a unit/amount as needed)
